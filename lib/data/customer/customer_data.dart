...
class CustomerData {
  Future<Operation> createCustomer(
      Dio dio, CreateCustomerRequest request, String baseUrl) async {
    try {
  ...
  Future<Operation> updateCustomer(
      Dio dio, String id, UpdateCustomerRequest request, String baseUrl) async {
    try {
  ...
  Future<Operation> addCarToCustomer(Dio dio, String id,
      AddCarToCustomerRequest request, String baseUrl) async {
    try {
      Response response = await dio.patch(
  ...
  Future<Operation> getAllCustomers(Dio dio, String baseUrl) async {
    try {
      Response response =
          await dio.get("https://zeitan.herokuapp.com/customers");
  ...
  Future<Operation> deleteCustomer(Dio dio, String id, String baseUrl) async {
    try {
      Response response =
          await dio.delete("https://zeitan.herokuapp.com/customers/$id");
      print(response.data);
    } on DioError catch (e) {
      print(e.message);
    }
